...
Static HTML, no build. Open `index.html` in a browser, or run `python3 -m http.server` in the repo root. Check the page in a narrow window too; nothing may scroll horizontally.
